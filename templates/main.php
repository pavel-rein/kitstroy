            ...
            <div class="container">
                <div class="w3-row">
                    <div class="w3-col l12 w3-padding-large">
                        <h2 class="w3-xxlarge">
                            <b>Аренда спецтехники по назначению</b>
                        </h2>
                ...
                <div class="w3-row">
                    <div class="w3-col l6 w3-padding-large">
                        <p>
                            Аренда спецтехники для землеройной, погрузочных, высотных, транспортировочных, дорожно-ремонтных, коммунальных, строительных и демонтажных работ. Оставьте номер телефона под интересующей вас техникой, мы рассчитаем стоимость заказа с учетом расстояния и количества смен. Также поможем подобрать лучший вариант под ваши задачи. В наличии 54 единиц техники.
                        </p>
                    </div>
                    <div class="w3-col l6">
                            ...
                            <div class='w3-row'>
                                ...
                                <div class='w3-col l6 w3-padding-large'>
                                    ...
                                    <form class='w3-col l10' action='index.php' method='POST'>
                                        ...
                                        <button class='w3-btn w3-block w3-indigo w3-round'>Получить расчет аренды</button>
